...
public class EnumeratedTypeValidator extends TypeValidator {
    ...
    public EnumeratedTypeValidator( NsIdentification nsIdentification ) {
    ...
    public boolean validateAbstractDataAttribute( AbstractDataAttribute ada, DiagnosticChain diagnostics ) {
        ...
        console.debug( NsdValidator.VALIDATION_NSD_CATEGORY, ada.getLineNumber(),
                       "EnumeratedTypeValidator.validateAbstractDataAttribute( ", ada.getName(), " ) in namespace \"", nsIdentification, "\"" );
        ...
        Pair< TypeValidator, NsIdentification > typeValidator = TypeValidator.get( this.nsIdentification, ada.getRefersToEnumType().getId() );
        if(( typeValidator != null ) && ( typeValidator.getLeft() != null )) {
            typeValidator.getLeft().validateAbstractDataAttribute( ada, diagnostics );
        }
